...
import static challenge.MensagensExceptions.*;
...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
            ...
            if(idade<0)
                throw new IllegalArgumentException(IDADE_NEGATIVA);
        ...
        public MotoristaBuilder withPontos(int pontos) {
            ...
            if(pontos<0)
                throw new IllegalArgumentException(PONTOS_NEGATIVOS);
        ...
        public Motorista build() {
            ...
            if(habilitacao==null)
                throw  new NullPointerException(SEM_HABILITACAO);
            else if(nome==null)
                throw new NullPointerException(SEM_NOME);
            else if(pontos>20)
                throw new EstacionamentoException(MOTORISTA_SEM_PONTOS);
            else if(idade>=0 && idade<18)
                throw new EstacionamentoException(MOTORISTA_MENOR);
